...
The learning model is chosen as Random Forest as its less prone to overfitting the data, Implicit cross validation is there as the best model is chosen considering the error rate in the **Out-Of-Bag(OOB) samples**.
